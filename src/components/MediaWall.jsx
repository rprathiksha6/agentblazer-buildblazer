...
export const MediaWall = () => {
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-slate-100/60 dark:bg-black/40 border-y border-slate-200 dark:border-white/5">
      {/* Glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6 mb-12">
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-200/80 dark:bg-black/60 border border-slate-300 dark:border-white/10 text-xs font-mono text-cyan-700 dark:text-cyan-300">
          ...
          {mediaItems.map((item) => (
            ...
            >
              ...
              <div className="flex items-center justify-between z-10">
                <span className="px-2.5 py-1 rounded-full text-[10px] font-mono tracking-wider bg-slate-100 dark:bg-black/60 text-cyan-700 dark:text-cyan-300 border border-slate-300 dark:border-white/10">
                  {item.tag}
                </span>
              ...
              <div className="z-10 py-3">
                <div className="w-10 h-10 rounded-xl bg-white/20 dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center text-cyan-600 dark:text-cyan-300 group-hover:scale-110 transition-transform">
              ...
              <div className="z-10 space-y-1">
                <h3 className="text-base font-display font-bold text-slate-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-300 transition-colors">
                  {item.title}
                </h3>
              ...
              <div className="absolute bottom-3 right-4 opacity-0 group-hover:opacity-100 transition-opacity text-[11px] font-mono text-cyan-600 dark:text-cyan-300 flex items-center gap-1 z-10">
